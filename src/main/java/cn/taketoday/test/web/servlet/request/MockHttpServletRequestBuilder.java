...
public class MockHttpServletRequestBuilder
  ...
  private final MultiValueMap<String, Object> headers = new DefaultMultiValueMap<>();

  private final MultiValueMap<String, String> parameters = new DefaultMultiValueMap<>();

  private final MultiValueMap<String, String> queryParams = new DefaultMultiValueMap<>();
