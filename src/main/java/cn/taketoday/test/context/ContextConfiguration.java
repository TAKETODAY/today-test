...
public @interface ContextConfiguration {
   ...
   * {@link cn.taketoday.test.context.support.AbstractContextLoader#modifyLocations
   ...
   * {@link cn.taketoday.test.context.support.AbstractContextLoader#generateDefaultLocations
   ...
   * {@link cn.taketoday.test.context.support.AbstractContextLoader
   * AbstractContextLoader} subclass such as
   * {@link cn.taketoday.test.context.support.GenericXmlContextLoader GenericXmlContextLoader} or
   * {@link cn.taketoday.test.context.support.GenericGroovyXmlContextLoader GenericGroovyXmlContextLoader}
   ...
   * {@link cn.taketoday.context.ApplicationContext ApplicationContext}.
   * <p>Check out the javadoc for
   * {@link cn.taketoday.test.context.support.AnnotationConfigContextLoader#detectDefaultConfigurationClasses
   ...
   * {@link cn.taketoday.test.context.support.DelegatingSmartContextLoader
   * DelegatingSmartContextLoader} or
   * {@link cn.taketoday.test.context.web.WebDelegatingSmartContextLoader
   * WebDelegatingSmartContextLoader} depending on the absence or presence of
   * {@link cn.taketoday.test.context.web.WebAppConfiguration
   ...
   * {@link cn.taketoday.test.context.support.AbstractContextLoader AbstractContextLoader},
   * {@link cn.taketoday.test.context.support.GenericXmlContextLoader GenericXmlContextLoader},
   * {@link cn.taketoday.test.context.support.GenericGroovyXmlContextLoader GenericGroovyXmlContextLoader},
   * {@link cn.taketoday.test.context.support.AnnotationConfigContextLoader AnnotationConfigContextLoader},
   * {@link cn.taketoday.test.context.web.GenericXmlWebContextLoader GenericXmlWebContextLoader},
   * {@link cn.taketoday.test.context.web.GenericGroovyXmlWebContextLoader GenericGroovyXmlWebContextLoader}, and
   * {@link cn.taketoday.test.context.web.AnnotationConfigWebContextLoader AnnotationConfigWebContextLoader}.
   */
