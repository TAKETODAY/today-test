...
abstract class BootstrapUtils {
   ...
   * <p>Uses reflection to create a {@link cn.taketoday.test.context.support.DefaultBootstrapContext}
   ...
   * {@link cn.taketoday.test.context.cache.DefaultCacheAwareContextLoaderDelegate}
  ...
  private static CacheAwareContextLoaderDelegate createCacheAwareContextLoaderDelegate() {
    ...
    try {
      ...
      if (logger.isDebugEnabled()) {
        logger.debug("Instantiating CacheAwareContextLoaderDelegate from class [{}]", className);
      }
      return BeanUtils.newInstance(clazz); // CacheAwareContextLoaderDelegate.class
    }
    catch (Throwable ex) {
  ...
  static TestContextBootstrapper resolveTestContextBootstrapper(BootstrapContext bootstrapContext) {
    ...
    try {
      ...
      TestContextBootstrapper testContextBootstrapper = (TestContextBootstrapper) BeanUtils.newInstance(clazz); //TestContextBootstrapper.class
