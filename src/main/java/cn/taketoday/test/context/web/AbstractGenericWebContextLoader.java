 ...
 * {@link cn.taketoday.test.context.ContextLoader ContextLoader} SPI.
 *
...
public abstract class AbstractGenericWebContextLoader extends AbstractContextLoader {
  ...
  public final ConfigurableApplicationContext loadContext(@NonNull MergedContextConfiguration mergedConfig) throws Exception {
    ...
    WebServletApplicationContext context = new StandardWebServletApplicationContext();
    ...
    customizeBeanFactory((StandardBeanFactory) context.getBeanFactory(), webMergedConfig);
   ...
   */
  protected void configureWebResources(WebServletApplicationContext context,
  ...
  /**
   * Load bean definitions into the supplied {@link WebApplicationContext context}
  ...
  protected abstract void loadBeanDefinitions(
          WebApplicationContext context, WebMergedContextConfiguration webMergedConfig);

  /**
   * Customize the {@link StandardWebServletApplicationContext} created by this context
  ...
  protected void customizeContext(
          StandardWebServletApplicationContext context, WebMergedContextConfiguration webMergedConfig) {
   ...
   * @see cn.taketoday.test.context.ContextLoader#loadContext(String[])
   */
  @Override
