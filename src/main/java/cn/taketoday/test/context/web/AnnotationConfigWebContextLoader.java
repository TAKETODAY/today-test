 ...
 * {@link cn.taketoday.test.context.ContextLoader ContextLoader} API. Thus,
 ...
 * considered a {@link cn.taketoday.test.context.SmartContextLoader SmartContextLoader}
 * rather than a {@link cn.taketoday.test.context.ContextLoader ContextLoader}.
 *
 * @author Sam Brannen
...
public class AnnotationConfigWebContextLoader extends AbstractGenericWebContextLoader {
  ...
  protected void loadBeanDefinitions(
    ...
    new AnnotatedBeanDefinitionReader(context).registerBean(annotatedClasses);
  }
