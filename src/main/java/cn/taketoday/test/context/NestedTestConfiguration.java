 ...
 * <li>{@link cn.taketoday.test.context.web.WebAppConfiguration @WebAppConfiguration}</li>
 ...
 * <li>{@link cn.taketoday.test.annotation.DirtiesContext @DirtiesContext}</li>
 * <li>{@link cn.taketoday.transaction.annotation.Transactional @Transactional}</li>
 * <li>{@link cn.taketoday.test.annotation.Rollback @Rollback}</li>
 * <li>{@link cn.taketoday.test.annotation.Commit @Commit}</li>
 * <li>{@link cn.taketoday.test.context.jdbc.Sql @Sql}</li>
 * <li>{@link cn.taketoday.test.context.jdbc.SqlConfig @SqlConfig}</li>
 * <li>{@link cn.taketoday.test.context.jdbc.SqlMergeMode @SqlMergeMode}</li>
